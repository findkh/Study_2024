package com.kh.real_world.user.security.filter;
...
import com.kh.real_world.user.security.auth.CustomUserPrincipal;
...
public class JWTCheckFilter extends OncePerRequestFilter {
	...
	protected boolean shouldNotFilter(HttpServletRequest request) throws ServletException {
		...
		if(request.getServletPath().startsWith("/api/v1/user/register")) {
			return true;
		}
