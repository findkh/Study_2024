package com.kh.real_world.profile.controller.advice;
...
public class ProfileControllerAdvice {
	...
	@ExceptionHandler(ProfileTaskException.class)
	public ResponseEntity<Map<String, String>> handleTaskException(ProfileTaskException e){
