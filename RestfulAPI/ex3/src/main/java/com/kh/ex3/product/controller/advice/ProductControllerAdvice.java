package com.kh.ex3.product.controller.advice;
...
import com.kh.ex3.product.exception.ProductTaskException;
...
public class ProductControllerAdvice {
	...
	public ResponseEntity<Map<String, String>> handleMethodArgumentNotValidException(MethodArgumentNotValidException e){
		...
		String errorMessage = errors.stream().map(ObjectError::getDefaultMessage).collect(Collectors.joining(", "));
