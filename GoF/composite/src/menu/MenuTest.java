...
public class MenuTest {
	public static void main(String[] args) {
		...
		pancakeHouseMenu.add(new MenuItem("레귤러 팬케이크 세트", "달갈 프라이와 소시지가 곁들여진 팬케이크", true, 2.99));
		...
		dessertMenu.add(new MenuItem("치즈 케이크", "초콜릿 그레이엄 크러스트 위에 브드러운 뉴욕 치즈 케이크", true, 1.99));
