...
export const makeRandomPostDate = () => {
...
export const randomRelativeDate = () => makeRelativeDate(makeRandomPostDate());

export const makeDayMonthYear = (date: Date) =>
  DateTime.fromJSDate(date).toLocaleString(DateTime.DATETIME_FULL);
export const randomDayMonthYear = () => makeDayMonthYear(makeRandomPostDate());
